			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<asp:Image class="details-banner--hero--img" ID="HeroImg" runat="server"/>
					</div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
							<asp:Image class="details-banner--info--box--img" ID="AvatarImg" runat="server"/>
						</a>
						<h1 class="details-banner--info--name" id="ArtistName" name="ArtistName" runat="server"><a class="details-banner--info--name--link" href="#"></a></h1>
					</div>
				</div>
							...
							<main class="discovery--section">
								...
								<section class="standard--holder">
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<asp:Repeater ID="SongDisplay" runat="server">
											<ItemTemplate>
												<li class="song-list--item media-player--row">
													...
													<div class="song-list--item--right">
														...
														<a class="song-list--item--secondary"><%# Convert.ToInt32(Eval("SongBPM"))%> BPM</a>
														<a class="song-list--item--secondary"><%# TimeSignature(Eval("SongTimeSignature").ToString())%></a>
														<div class="song-list--item--icon--holder">
																<a href="#" class="song-list--item--icon--wrap" style="display: inline-block" visible='<%#(bool)(Eval("SongMultiTracks"))%>' runat="server">
																...
																<a href="#" class="song-list--item--icon--wrap" style="display: inline-block" visible='<%#(bool)(Eval("SongCustomMix"))%>' runat="server">
																...
																<a href="#" class="song-list--item--icon--wrap" style="display: inline-block" visible='<%#(bool)(Eval("SongRehearsalMix"))%>' runat="server">
																...
																<a href="#" class="song-list--item--icon--wrap" style="display: inline-block" visible='<%#(bool)(Eval("SongPatches"))%>' runat="server">
																...
																<a href="#" class="song-list--item--icon--wrap" style="display: inline-block" visible='<%#(bool)(Eval("SongChart"))%>' runat="server">
																...
																<a href="#" class="song-list--item--icon--wrap" style="display: inline-block" visible='<%#(bool)(Eval("SongProPresenter"))%>' runat="server">
									...
									<section class="standard--holder">
										...
										<div class="discovery--grid-holder">
											...
											<div class="ly-grid ly-grid-cranberries">
												<asp:Repeater ID="AlbumDisplay" runat="server">
													<ItemTemplate>
													<div class="media-item">									
														<a class="media-item--img--link" href="#" tabindex="0">
															<img class="media-item--img" alt="<%#Eval("AlbumTitle")%>" src="<%#Eval("AlbumImg")%>">
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<p id="ArtistBio" name="ArtistBio" runat="server"></p>
										<a href="#">Read More...</a>
									</div>
