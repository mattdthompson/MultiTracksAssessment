...
<%--								<img class="details-banner--info--box--img"
						...
						<h1 class="details-banner--info--name" id="ArtistName" name="ArtistName" runat="server"><a class="details-banner--info--name--link" href="#">Bethel Music</a></h1>
					</div>
				</div>
							...
							<main class="discovery--section">
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<p id="ArtistBio" name="ArtistBio" runat="server">
